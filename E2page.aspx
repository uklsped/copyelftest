 ...
 <asp:HiddenField ID="LAHiddenFieldcontrol" runat="server" />
  ...
  <input id="inpHide" type="hidden" runat="server" value="9" />
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            ...
            <uc9:WriteDatauc ID="WriteDatauc1" LinacName="E2" UserReason="10"  Tabby="EndofDay"  WriteName="EndDayData"   Visible="False" runat="server" />
...
<asp:TabPanel ID="TabPanel1" runat="server" HeaderText="E2 Runup" DynamicContextKey='Engrunup' CssClass="ajax__tab_header"><ContentTemplate>
...
<asp:TabPanel ID="TabPanel8" runat="server" HeaderText="E2 Development/Training" DynamicContextKey='Devel' tabindex="8" CssClass="ajax__tab_header"><ContentTemplate>
...
<uc12:Traininguc ID="Traininguc1" LinacName = "E2" Tabby="8" UserReason="8" Visible="false" runat="server" />
        ...
        <asp:TabPanel ID="TabPanel9" runat="server" DynamicContextKey='Emerunup' HeaderText="E2 Emergency Runup" enabled="false"  TabIndex="7">
     <ContentTemplate>
...
<asp:Panel ID="TabContent9" runat="server" Visible="False">
 ...
 <uc1:ErunupUserControlCommon ID="ErunupUserControl2" LinacName="E2" Tabby = "9" UserReason = "9" DataName="EmeData" visible="false" runat="server" />
