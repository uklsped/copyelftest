<%@ Page Title="" Language="VB" MasterPageFile="~/Elf.master"  AutoEventWireup="false" CodeFile="B1page.aspx.vb" Inherits="B1page"  %>
 ...
 <asp:HiddenField ID="LAHiddenFieldcontrol" runat="server" />
  ...
  <input id="inpHide" type="hidden" runat="server" value="9" />
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            ...
            <uc9:WriteDatauc ID="WriteDatauc1" LinacName="B1" UserReason="10"  Tabby="EndofDay"  WriteName="EndDayData"   Visible="False" runat="server" />
    ...
    <ContentTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanel0" runat="server" >
            ...
            <asp:Panel ID="Panel0" runat="server" >
                    ...
                    <uc5:LinacStatusuc ID="LinacStatusuc1" LinacName="B1" runat="server" />
...
<asp:TabPanel ID="TabPanel3" runat="server" HeaderText="B1 Clinical">
        <ContentTemplate>
...
<uc3:ClinicalUserControl ID="ClinicalUserControl1"  LinacName="B1" DataName="ClinData" runat="server" visible="false"/>
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:TabPanel ID="TabPanel4" runat="server" HeaderText="B1 Planned Maintenance" >
        <ContentTemplate>
...
<uc6:PlannedMaintenanceuc ID="PlannedMaintenanceuc1" linacname="B1" runat="server" Visible="false" />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
  ...
  <asp:TabPanel ID="TabPanel5" runat="server" HeaderText="B1 Repair" >
        <ContentTemplate>
...
<uc7:Repairuc ID="Repairuc1" LinacName="B1" runat="server" Visible="false" />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:TabPanel ID="TabPanel8" runat="server" HeaderText="B1 Development/Training" DynamicContextKey='Devel' tabindex="8" CssClass="ajax__tab_header"><ContentTemplate>
...
<uc12:Traininguc ID="Traininguc1" LinacName = "B1" Tabby="8" UserReason="8" Visible="false" runat="server" />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
        ...
        <asp:TabPanel ID="TabPanel9" runat="server" DynamicContextKey='Emerunup' HeaderText="B1 Emergency Runup" enabled="false"  TabIndex="7">
     <ContentTemplate>
...
<asp:Panel ID="TabContent9" runat="server" Visible="False">
 ...
 <uc1:ErunupUserControlCommon ID="ErunupUserControl2" LinacName="B1" Tabby = "9" UserReason = "9" DataName="EmeData" visible="false" runat="server" />
